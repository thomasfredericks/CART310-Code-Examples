...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 291.0, 433.0, 124.0, 22.0 ],
					"text" : "print from_js_outlet_1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 142.0, 433.0, 124.0, 22.0 ],
					"text" : "print from_js_outlet_0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 792.0, 589.0, 328.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 792.0, 535.0, 328.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 792.0, 481.0, 328.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 142.0, 472.0, 644.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 376.5, 666.0, 33.0 ],
					"text" : "This is the [js] object. It currently loads the file \"JavaScriptInMax.js\" that is in the same folder as this patcher.\nDouble click it (in locked mode) to open the code editor."
				}
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						"filename" : "JavaScriptInMax.js",
						"parameter_enable" : 0
					}
,
					"text" : "js JavaScriptInMax.js"
				}
